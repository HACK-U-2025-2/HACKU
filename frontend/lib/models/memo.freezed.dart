...
@MemoIdJsonConverter() MemoId get id; String get title; String get body; String get raw; DateTime get createdAt; bool get isFavorite; List<Tag> get tags; DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,body,raw,createdAt,isFavorite,const DeepCollectionEquality().hash(tags),updatedAt);

@override
String toString() {
  return 'Memo(id: $id, title: $title, body: $body, raw: $raw, createdAt: $createdAt, isFavorite: $isFavorite, tags: $tags, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
@MemoIdJsonConverter() MemoId id, String title, String body, String raw, DateTime createdAt, bool isFavorite, List<Tag> tags, DateTime? updatedAt
});
...
/// Create a copy of Memo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? body = null,Object? raw = null,Object? createdAt = null,Object? isFavorite = null,Object? tags = null,Object? updatedAt = freezed,}) {
...
class _Memo extends Memo {
  const _Memo({@MemoIdJsonConverter() required this.id, required this.title, required this.body, required this.raw, required this.createdAt, this.isFavorite = false, final  List<Tag> tags = const [], this.updatedAt}): _tags = tags,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,body,raw,createdAt,isFavorite,const DeepCollectionEquality().hash(_tags),updatedAt);
...
/// Create a copy of Memo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? body = null,Object? raw = null,Object? createdAt = null,Object? isFavorite = null,Object? tags = null,Object? updatedAt = freezed,}) {
  return _then(_Memo(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as MemoId,title: null == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String,body: null == body ? _self.body : body // ignore: cast_nullable_to_non_nullable
